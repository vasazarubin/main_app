...
void widgetKeyBoard::setKeyButtonSize(QSize size)
{
    m_key_button_size = size;
}
...
QKeyPushButton * widgetKeyBoard::createNewKey(QString keyValue)
{
    ...
    if (m_key_button_size.width() == 0 || m_key_button_size.height() == 0)
    {
    ...
    {
        imageDim.setHeight(m_key_button_size.height());
        imageDim.setWidth(m_key_button_size.width());
    }
